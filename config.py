...
OWNER_USERNAME = getenv("OWNER_USERNAME", "SandVillage_network")
# Get Your bot username
BOT_USERNAME = getenv("BOT_USERNAME" , "temariXmusic_probot")
# Don't Add style font 
BOT_NAME = getenv("BOT_NAME", "TEMRI MUSIC")
#get Your Assistant User name
ASSUSERNAME = getenv("ASSUSERNAME", "TemriXassistant")
EVALOP = list(map(int, getenv("EVALOP", "6461049289").split()))
...
OWNER_ID = int(getenv("OWNER_ID", 6461049289))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Princeshelby/DAXXMUSIC",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Itadori_Updates")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Itadori_support_chat")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://telegra.ph/file/5717b12cf51566f7a28ff.jpg"
)
PING_IMG_URL = getenv(
...
TELEGRAM_AUDIO_URL = "https://mallucampaign.in/images/img_1703839282.jpg"
TELEGRAM_VIDEO_URL = "https://mallucampaign.in/images/img_1703839282.jpg"
